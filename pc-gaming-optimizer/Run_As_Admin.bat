...
set "FLAG=%LOCALAPPDATA%\Temp\GamingOptimizer_elevated.flag"
...
echo elevated > "%FLAG%"
"%PS%" -NoProfile -ExecutionPolicy Bypass -File "%~dp0PC_Optimizer.ps1"
set "RC=%ERRORLEVEL%"
echo [%date% %time%] PC_Optimizer.ps1 exited with %RC% >> "%LOG%"
if not "%RC%"=="0" (
    echo.
